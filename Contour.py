...
def create_elipse_contour(source, num_points):
    ...
    # contain the X and Y coordinates respectively of points on a circle centered at the center of the image, 
    # with radii of 180 and 190 units respectively, corresponding to the angles provided in the array t.
